...
var entriesURL = 'https://www.concursolutions.com/api/v3.0/expense/entries';
...
describe('Entries Unit Tests', function() {
  beforeEach(function() {
    requestMockData = {
      options: null,
      callback: null,
  ...
  describe('#GET', function() {
    it('should contain proper options',function(){
      concur.entries.get(sampleRequest).then(function(){});
    ...
    it('request should contain proper options',function(){
      concur.entries.get(sampleRequestQs).then(function(){});
      requestMockData.options.url.should.equal(entriesURL);
    ...
    it('should return an error if one is returned in the callback of request',function(){
      concur.entries.get(sampleRequest)
      .then(function(){})
    ...
    it('should parse XML response into JSON',function(){
      concur.entries.get(sampleRequestXml)
      .then(function(data){
    ...
    it('should parse the JSON',function(){
      concur.entries.get(sampleRequestNoContentType)
        .then(function(data){
          data.sample.should.be.true;
        });
      requestMockData.options.url.should.equal(entriesURL);
