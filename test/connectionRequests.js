...
describe('connectionRequests Unit Tests', function() {
  beforeEach(function() {
    requestMockData = {
      options: null,
      callback: null,
  ...
  describe('#GET', function() {
    it('should contain proper options',function(){
      concur.connectionRequests.get(sampleRequest).then(function(){});
    ...
    it('request should contain proper options',function(){
      concur.connectionRequests.get(sampleRequestQs).then(function(){});
      requestMockData.options.url.should.equal(entriesURL);
    ...
    it('should return an error if one is returned in the callback of request',function(){
      concur.connectionRequests.get(sampleRequest)
      .then(function(){})
    ...
    it('should parse XML response into JSON',function(){
      concur.connectionRequests.get(sampleRequestXml)
      .then(function(data){
    ...
    it('should parse the JSON',function(){
      concur.connectionRequests.get(sampleRequestNoContentType)
        .then(function(data){
          data.sample.should.be.true;
        });
      requestMockData.options.url.should.equal(entriesURL);
